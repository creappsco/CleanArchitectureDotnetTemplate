...
namespace Clean.Infraestructure.Identity.Services
{
    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<AuthenticationResponse> AuthenticateAsync(AuthenticationRequest request)
        {
            ...
            if (user == null)
            {
                throw new Exception($"El Usuario con Email {request.Email} no fué encontrado.");
            }
            ...
            if (!result.Succeeded)
            {
                throw new Exception($"La información para '{request.Email}' no es válida.");
            }
        ...
        public async Task<RegistrationResponse> RegisterAsync(RegistrationRequest request, string rol)
        {
            ...
            {
                throw new Exception($"El usuario '{request.Email}' ya se encuentra registrado.");
            }
